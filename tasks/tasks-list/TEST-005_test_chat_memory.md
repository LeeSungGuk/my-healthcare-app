...
- [ ] `memory consent true/false, memory 미사용 시 fabricated past 금지 테스트 작성`의 Given/When/Then 시나리오를 테스트 파일로 분리한다.
...
- Given: `memory consent true/false, memory 미사용 시 fabricated past 금지 테스트 작성` 요구사항이 구현되지 않은 상태임
- When: 신규 테스트를 실행함
