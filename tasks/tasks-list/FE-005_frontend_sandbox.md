...
- [ ] `Sandbox Scenario Picker UI 구현: 합성 profile, sample utterance, scenario preset` 화면 또는 component를 Tailwind CSS와 shadcn/ui 기준으로 구현한다.
...
- When: `Sandbox Scenario Picker UI 구현: 합성 profile, sample utterance, scenario preset` 화면을 열람하거나 action을 실행함
