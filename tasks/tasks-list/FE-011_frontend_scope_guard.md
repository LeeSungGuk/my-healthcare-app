...
- 목적: SRS `실버케어_SRS_v0.5_단일구조.md`의 `REQ-FUNC-060, 1.2 Out-of-Scope, 6.6` 요구를 구현 가능한 작업 단위로 완성한다.
...
- [ ] `Guardian app, institution dashboard, elder app 목적 route/navigation 미생성 검증용 UI route inventory 작성` 화면 또는 component를 Tailwind CSS와 shadcn/ui 기준으로 구현한다.
...
- When: `Guardian app, institution dashboard, elder app 목적 route/navigation 미생성 검증용 UI route inventory 작성` 화면을 열람하거나 action을 실행함
