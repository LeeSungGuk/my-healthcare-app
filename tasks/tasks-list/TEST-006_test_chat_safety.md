...
- [ ] `의료/응급/자해 발화 200 안전 응답, prompt injection 422 SAFETY_FILTERED 테스트 작성`의 Given/When/Then 시나리오를 테스트 파일로 분리한다.
...
- Given: `의료/응급/자해 발화 200 안전 응답, prompt injection 422 SAFETY_FILTERED 테스트 작성` 요구사항이 구현되지 않은 상태임
- When: 신규 테스트를 실행함
